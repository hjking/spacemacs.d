;;; packages.el --- hjking-org layer packages file for Spacemacs.
;;
...
;; added to `hjking-org-packages'. Then, for each package PACKAGE:
;;
;; - If PACKAGE is not referenced by any other Spacemacs layer, define a
;;   function `hjking-org/init-PACKAGE' to load and initialize the package.

;; - Otherwise, PACKAGE is already referenced by another Spacemacs layer, so
;;   define the functions `hjking-org/pre-init-PACKAGE' and/or
;;   `hjking-org/post-init-PACKAGE' to customize the package as it is loaded.

;;; Code:

(defconst hjking-org-packages
  '(
    (org :location built-in)
    org-trello
    calfw
    )
  "The list of Lisp packages required by the hjking-org layer.
...
(defun hjking-org/post-init-org ()
  (use-package org
    ;; (require 'org-install)
    ;; (require 'org-faces)
    ;; (require 'cus-edit)
...
(defun hjking-org/init-org-trello ()
