...
; (defun hjking-misc/post-init-hydra ()
;   (progn
...
;     ;; Key Binding
;     ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;     (spacemacs/set-leader-keys "oa"  'hjking-hydra-avy/body)
;     (spacemacs/set-leader-keys "ob"  'hjking-hydra-buffer-move/body)
;     (spacemacs/set-leader-keys "oc"  'hjking-hydra-multiple-cursors/body)
;     (spacemacs/set-leader-keys "od"  'hjking-hydra-delete/body)
;     (spacemacs/set-leader-keys "of"  'hjking-hydra-fold/body)
;     (spacemacs/set-leader-keys "oh"  'hjking-hydra-hl-anything/body)
;     (spacemacs/set-leader-keys "ol"  'hjking-hydra-highlight-symbol/body)
;     (spacemacs/set-leader-keys "og"  'hjking-hydra-git/body)
;     (spacemacs/set-leader-keys "om"  'hjking-hydra-markdown-mode/body)
;     (spacemacs/set-leader-keys "on"  'hjking-hydra-navigate/body)
;     (spacemacs/set-leader-keys "oo"  'hjking-hydra-org/body)
;     (spacemacs/set-leader-keys "op"  'hjking-hydra-projectile/body)
;     (spacemacs/set-leader-keys "or"  'hjking-hydra-rectangle/body)
;     (spacemacs/set-leader-keys "ot"  'hjking-hydra-toggle-mode/body)
;     (spacemacs/set-leader-keys "ow"  'hjking-hydra-window/body)
;     (spacemacs/set-leader-keys "ov"  'hjking-hydra-verilog-mode-main/body)
;     (spacemacs/set-leader-keys "oy"  'hjking-hydra-yasnippet/body)
;     (spacemacs/set-leader-keys "oz"  'hjking-hydra-zoom/body)
;     (spacemacs/set-leader-keys "o."  'hjking-hydra-buffer-menu/body)
;     (spacemacs/set-leader-keys "o@"  'hjking-hydra-macro/body)
;     (spacemacs/set-leader-keys "o\"" 'hjking-hydra-registers/body)
